...
class CardProfile extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
    {
      index: 3,
      currentTime: '0:00',
      musicList: [{ name: 'ĐAU ĐỂ TRƯỞNG THÀNH', author: 'Onlyc', img: 'IMG/alb.png', audio: 'mussic/daudetruongthanh.mp3', duration: '4:17' },
      { name: 'VÔ HÌNH TRONG TIM EM', author: 'MRSIRO', img: 'IMG/alb.png', audio: 'mussic/vohinhtrongtimem.mp3', duration: '5:30' },
      { name: 'NGÀY HÔM QUA ĐÃ TỪNG', author: 'M NAIVE', img: 'IMG/alb.png', audio: 'mussic/ngayhomquadatung.mp3', duration: '5:40' },
      { name: 'Euterpe', author: 'EGOIST',img: 'IMG/alb.png', audio: 'mussic/Euterpe.mp3', duration: '3:49' }],
